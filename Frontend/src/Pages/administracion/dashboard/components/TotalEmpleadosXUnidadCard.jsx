...
const TotalEmpleadosXUnidadCard = () => {
  const chartRef = useRef(null);

  useEffect(() => {
    // Datos para el gráfico de ejemplo
    const data = {
      labels: ["Unidad Administrativa", "Unidad Operativa", "Otra Unidad"],
      datasets: [
        {
...
export default TotalEmpleadosXUnidadCard;
